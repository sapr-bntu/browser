...
**
** Created: Sun 4. Mar 20:40:25 2012
...
""));
        ...
        actionConnect = new QAction(Browser);
...
""));
        ...
        QObject::connect(actionAbout, SIGNAL(activated()), Browser, SLOT(show()));
    ...
    void retranslateUi(QMainWindow *Browser)
    {
        ...
        actionConnect->setText(QApplication::translate("Browser", "actionConnect", 0, QApplication::UnicodeUTF8));
